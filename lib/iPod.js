...
if($("#audioplayer").is(":visible") == true){
  ...
  if ($('.select').attr('id') === 'backlight-link') {
    let backgroundGrad = backlit ? 'linear-gradient(45deg, rgb(160, 167, 170) 0%, rgb(185, 188, 193) 49%, rgb(185, 186, 191) 51%, rgb(197, 197, 203) 100%)' : 'linear-gradient(45deg, rgb(162, 175, 219) 0%, rgb(186, 194, 223) 49%, rgb(184, 192, 219) 51%, rgb(171, 182, 218) 100%)';
